...
<script>
    ...
    function buildBulkRows() {
        ...
        <td data-label="Harga Beli"><input type="text" class="form-control form-control-sm text-end bulk-harga-beli price-format" name="harga_beli[]" value="${fmt(last ? last.harga_beli : 0)}"></td>
        <td data-label="Harga Jual"><input type="text" class="form-control form-control-sm text-end bulk-harga-jual price-format" name="harga_jual[]" value="${fmt(last ? last.harga_jual : 0)}"></td>
        <td data-label="Fee Outlet"><input type="text" class="form-control form-control-sm text-end bulk-fee price-format" name="fee_outlet[]" value="${fmt(last ? last.fee_outlet : 0)}"></td>
