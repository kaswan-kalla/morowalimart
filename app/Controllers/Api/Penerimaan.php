...
/**
 * API Penerimaan - input barang masuk oleh petugas outlet (tanpa login)
 * id_lokasi dikirim dari app dalam body request
 */
class Penerimaan extends BaseController
{
    /**
     * POST /api/v1/penerimaan
     * Body: {"id_lokasi":1, "tanggal": "2026-08-08", "items": [{"id_barang":1,"harga_beli":1000,"harga_jual":1500,"fee_outlet":100,"jumlah":10,"keterangan":""}]}
     */
    public function store()
    {
        ...
        foreach ($items as $i => $item) {
            ...
            $model->insert([
                ...
                'fee_outlet' => (float) ($item['fee_outlet'] ?? 0),
                'jumlah'     => $jumlah,
                'tanggal'    => $tanggal,
        ...
        return $this->response->setJSON([
            'status'  => $saved > 0,
            'message' => $saved > 0 ? $saved . ' item pembelian berhasil disimpan' : 'Tidak ada item valid untuk disimpan',
        ]);
    }
}
